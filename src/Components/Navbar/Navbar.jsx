...
export default function Navbar() {
  ...
  return (
    <>
      <Box id="navbar" bg={useColorModeValue('white.100', 'gray.900')} px={4}>
        <Flex h={16} alignItems="center" justifyContent="space-between">
          <ReachLink to="/">
            <Box>
              <img style={{ height: '44px' }} className="logo" src={r1} alt="logo" />
            </Box>
          </ReachLink>

          <HStack as="nav" spacing={4} display={{ base: 'none', md: 'flex' }} alignItems="flex-start">
            <ReachLink
              px={2}
              py={1}
              rounded="md"
        ...
        {isOpen ? (
          <Box pb={4} display={{ md: 'none' }}>
            <Stack as="nav" spacing={4}>
              <ReachLink px={2} py={1} rounded="md" _hover={{ textDecoration: 'none', bg: 'gray.200' }} to="/">
                Home
              </ReachLink>
              <ReachLink px={2} py={1} rounded="md" _hover={{ textDecoration: 'none', bg: 'gray.200' }} to="/about">
                About
              </ReachLink>
            </Stack>
          </Box>
